...
$.ajax({
    ...
    success: function (data) {
        ...
        Highcharts.chart('distribuicao_probabilidades', {
            title: {
                text: 'Probabilidade de ataque dos personagem e do boss'
            },
...
$.ajax({
    url:'/dashboard/probabilidades/',
    type: "GET",
    data: {id_jogo: 1, csrfmiddlewaretoken: '{{ csrf_token }}'},
    dataType: 'json',
    success: function (data) {
        dashboard_distribuicao_probabilidades = data;
        console.log('Exibindo a distribuição de probabilidade por rodadas\n');
        console.log(dashboard_distribuicao_probabilidades);
