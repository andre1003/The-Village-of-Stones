var preStage4State = { 
	create: function(){
		...
		this.content = [
			"",
		    "Herói: Finalmente, o último monstro.",
		    "Voss: Então é assim que você nos enxerga? Criaturas \nmalignas?",
		    "Herói: Eu só quero retornar a paz da minha vila!",
		    "Voss: Assim seja sua vontade... “Herói”."
		];
