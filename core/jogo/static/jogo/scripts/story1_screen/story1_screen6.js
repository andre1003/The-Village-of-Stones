var story1Screen6State = {
	create: function() {
		this.conteudo = [
			"Agora o herói segue sua jornada a procura das quatro pedras e da justiça."
		];
		this.line = [];
		this.wordIndex = 0;
		this.lineIndex = 0;
		...
		this.texto = game.add.text(210, 270, '', {font: "20px Montserrat", fill: "#fff"});
    	this.nextLine();
	},
	...
	nextLine: function() {
	    if (this.lineIndex === this.conteudo.length)
	    {
	        ...
	        game.time.events.add(4000, function() {game.state.start('story1_screen7');}, this);
	        return;
	    }
